            ...
            <a-spin :spinning="loading">
                <a-card v-if="inviteLink" :title="`来自 ${inviteLink.member.name} 的邀请`">
                    ...
                    <span>
                        ...
                        <span v-if="inviteLink.invite_type == 'project'">加入项目「{{inviteLink.projectInfo.name}}」</span>
                        <span v-if="inviteLink.invite_type == 'organization'">加入组织「{{inviteLink.organization.name}}」</span>
